        ...
        <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;max-width:560px;width:100%;">
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0 0 20px;font-size:15px;color:#1a1a1a;line-height:1.7;font-family:Arial,sans-serif;">Merci de rejoindre cette phase d'exploration.</p>
              ...
              <p style="margin:0 0 28px;font-size:15px;color:#1a1a1a;line-height:1.7;font-family:Arial,sans-serif;">Il ne s'agit pas de répondre oui ou non — mais d'exprimer <em>pourquoi</em> vous vous positionnez comme vous le faites. Votre réponse contribuera directement à la construction du projet.</p>

              <table cellpadding="0" cellspacing="0" style="margin:0 0 32px;">
                <tr>
                  <td style="background:#f97316;border-radius:8px;padding:14px 28px;">
                    <a href="https://tally.so/r/KY0g9X" style="color:white;font-size:15px;font-weight:700;text-decoration:none;font-family:Arial,sans-serif;letter-spacing:0.01em;">Répondre à la question →</a>
                  </td>
                </tr>
              </table>
...
Merci de rejoindre cette phase d'exploration.
...
Il ne s'agit pas de répondre oui ou non — mais d'exprimer pourquoi vous vous positionnez comme vous le faites. Votre réponse contribuera directement à la construction du projet.

→ Répondre à la question : https://tally.so/r/KY0g9X

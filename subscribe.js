...
Si elle devient une question publiée, vous serez le premier prévenu.

En attendant, vous pouvez aussi répondre à la question actuellement ouverte :
→ https://tally.so/r/A7Rj7W?utm_source=email_suggestion
...
---
Désinscription : hello.voxol@proton.me`
          }
        : {
            subject: 'vOxOl — Bienvenue, une question vous attend',
            html: `
<!DOCTYPE html>
<html lang="fr">
<head>
        ...
        <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;max-width:560px;width:100%;">
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0 0 20px;font-size:15px;color:#1a1a1a;line-height:1.7;font-family:Arial,sans-serif;">Merci de faire partie des premières personnes à tester vOxOl.</p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 28px;">
                <tr>
                  <td style="background:#f8f8f8;border-radius:8px;padding:18px 20px;">
                    <p style="margin:0;font-size:13.5px;color:#555;line-height:1.75;font-family:Arial,sans-serif;">Une question est ouverte en ce moment. La suite dépendra de ce qu'elle révèle.</p>
                  </td>
                </tr>
              </table>

              <p style="margin:0 0 12px;font-size:16px;color:#1a1a1a;line-height:1.55;font-family:Arial,sans-serif;font-weight:700;">La question en cours vous attend dès maintenant.</p>
              <p style="margin:0 0 28px;font-size:15px;color:#1a1a1a;line-height:1.7;font-family:Arial,sans-serif;">Il ne s'agit pas de répondre oui ou non — mais d'exprimer <em>pourquoi</em>. Votre réponse contribuera à la cartographie de ce débat.</p>

              <table cellpadding="0" cellspacing="0" style="margin:0 0 20px;">
                <tr>
                  <td style="background:#f97316;border-radius:8px;padding:14px 28px;">
                    <a href="https://tally.so/r/A7Rj7W?utm_source=email_welcome" style="color:white;font-size:15px;font-weight:700;text-decoration:none;font-family:Arial,sans-serif;letter-spacing:0.01em;">Répondre à la question →</a>
                  </td>
                </tr>
              </table>

              <p style="margin:0 0 24px;font-size:14px;color:#555;line-height:1.7;font-family:Arial,sans-serif;">Vous pourrez lire la carte du débat, et y voir votre place — une fois assez de réponses réunies.</p>

              <p style="margin:0 0 28px;font-size:13px;color:#888;line-height:1.65;font-family:Arial,sans-serif;font-style:italic;">Vous recevrez les prochaines questions à mesure qu'elles sortent — pas de newsletter, pas de promotions.</p>
          ...
          <tr>
            <td style="background:#f8f8f8;padding:20px 40px;text-align:center;border-top:1px solid #eeeeee;">
              ...
              <p style="margin:0 0 6px;font-size:11px;color:#bbb;font-family:Arial,sans-serif;">© 2026 vOxOl · Concept en exploration</p>
              <p style="margin:0;font-size:11px;color:#bbb;font-family:Arial,sans-serif;">Vous ne souhaitez plus recevoir ces emails ? <a href="mailto:hello.voxol@proton.me?subject=Désinscription" style="color:#999;text-decoration:underline;">Cliquez ici</a>.</p>
            </td>
          </tr>
        </table>
      </td>
...
Merci de faire partie des premières personnes à tester vOxOl.
...
Une question est ouverte en ce moment. La suite dépendra de ce qu'elle révèle.

La question en cours vous attend dès maintenant.

Il ne s'agit pas de répondre oui ou non — mais d'exprimer pourquoi. Votre réponse contribuera à la cartographie de ce débat.

→ Répondre à la question : https://tally.so/r/A7Rj7W?utm_source=email_welcome

Vous pourrez lire la carte du débat, et y voir votre place — une fois assez de réponses réunies.

Vous recevrez les prochaines questions à mesure qu'elles sortent — pas de newsletter, pas de promotions.
